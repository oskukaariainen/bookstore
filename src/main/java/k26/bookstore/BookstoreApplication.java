...
public class BookstoreApplication {
	...
	public CommandLineRunner bookDemo(BookRepository bookRepository, CategoryRepository categoryRepository,
		...
		return (args) -> {
			...
			bookRepository.save(new Book("Kirja1 ", "Kirjoittaja1", 3232, "asdasddsa", 1, category1));
			bookRepository.save(new Book("Kirja2", "Kirjoittaja2", 2000, "asdasd", 3, category2));
			bookRepository.save(new Book("Kirja3", "Kirjoittaja3", 2000, "asdsad", 3, category3));
